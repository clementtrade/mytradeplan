            ...
            <div style={{ flex: 1 }}>
              ...
              {[{ name: 'Break & retest', wr: 78, r: '+2.4R', pos: true }, { name: 'Continuation', wr: 65, r: '+1.8R', pos: true }, { name: 'Mean reversion', wr: 35, r: '-0.4R', pos: false }].map((s, i) => (
                <div key={i} style={{ marginBottom: '10px' }}>
                  ...
                  <div style={{ height: '6px', background: '#f0f0f0', borderRadius: '4px' }}>
                    <div style={{ width: `${s.wr}%`, height: '100%', background: s.pos ? '#111' : '#dc2626', borderRadius: '4px', transition: 'width 0.6s ease' }}></div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div style={{ background: '#fff', border: '0.5px solid #e8e8e8', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.06)' }} className="mockup-float-3">
            ...
            <div style={{ padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              <div style={{ paddingBottom: '8px', borderBottom: '0.5px solid #f0f0f0' }}>
                ...
                <div style={{ fontSize: '10px', color: '#555', lineHeight: 1.65, paddingLeft: '12px' }}>J-3 avant la clôture du Q2. Le rééquilibrage institutionnel génère des flux atypiques. Restez discipliné.</div>
              </div>
