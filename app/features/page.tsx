  ...
  return (
    <main style={{ minHeight: '100vh', background: '#fff', fontFamily: 'Inter, sans-serif', color: '#111' }}>
      ...
      <style>{`
        ...
        .macro-section { font-size: 11px; font-weight: 700; margin-bottom: 6px; }
      ...
      <div className="feat-section">
        <div>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#f5f3ff', border: '0.5px solid #ddd6fe', borderRadius: '20px', padding: '3px 12px', marginBottom: '1rem' }}>
            <span style={{ fontSize: '11px', color: '#7c3aed', fontWeight: 600 }}>PRO</span>
          </div>
        ...
        <div style={{ background: '#fff', border: '0.5px solid #e8e8e8', borderRadius: '16px', padding: '1.25rem', boxShadow: '0 8px 40px rgba(0,0,0,0.08)', overflow: 'hidden' }} className="float-3">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
            <span style={{ fontSize: '13px', fontWeight: 600, color: '#111' }}>Stats avancées</span>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: '6px', marginBottom: '6px' }}>
            <div className="adv-card">
              <div style={{ fontSize: '9px', color: '#aaa', marginBottom: '3px' }}>Expectancy</div>
              <div style={{ fontSize: '15px', fontWeight: 700, color: '#16a34a', fontFamily: 'monospace' }}>+87$</div>
              <div style={{ fontSize: '8px', color: '#aaa', margin: '3px 0 5px' }}>gain espéré / trade</div>
            ...
            <div className="adv-card">
              <div style={{ fontSize: '9px', color: '#aaa', marginBottom: '3px' }}>Sharpe ratio</div>
              <div style={{ fontSize: '15px', fontWeight: 700, color: '#111', fontFamily: 'monospace' }}>1.42</div>
              <div style={{ fontSize: '8px', color: '#aaa', margin: '3px 0 5px' }}>rendement / risque</div>
            ...
            <div className="adv-card">
              <div style={{ fontSize: '9px', color: '#aaa', marginBottom: '3px' }}>Max drawdown</div>
              <div style={{ fontSize: '15px', fontWeight: 700, color: '#dc2626', fontFamily: 'monospace' }}>-842$</div>
              <div style={{ fontSize: '8px', color: '#aaa', margin: '3px 0 5px' }}>pire série de pertes</div>
            ...
            <div className="adv-card">
              <div style={{ fontSize: '9px', color: '#aaa', marginBottom: '3px' }}>Consistency</div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                <div>
                  <div style={{ fontSize: '15px', fontWeight: 700, color: '#111', fontFamily: 'monospace' }}>65%</div>
                  <div style={{ fontSize: '8px', color: '#aaa' }}>plan suivi</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '6px' }}>
            <div className="adv-card" style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '13px', fontWeight: 700, color: '#16a34a', fontFamily: 'monospace' }}>+29%</div>
              <div style={{ fontSize: '8px', color: '#aaa', marginTop: '2px' }}>Distance BE</div>
            </div>
            <div className="adv-card" style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '13px', fontWeight: 700, color: '#16a34a', fontFamily: 'monospace' }}>+3W</div>
              <div style={{ fontSize: '8px', color: '#aaa', marginTop: '2px' }}>Streak</div>
            </div>
            <div className="adv-card" style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '13px', fontWeight: 700, color: '#16a34a', fontFamily: 'monospace' }}>+910$</div>
              <div style={{ fontSize: '8px', color: '#aaa', marginTop: '2px' }}>Meilleur jour</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="feat-section">
          <div style={{ background: '#fff', border: '0.5px solid #e8e8e8', borderRadius: '16px', padding: '1.25rem 1.5rem', boxShadow: '0 8px 40px rgba(0,0,0,0.08)', overflow: 'hidden' }} className="float-4">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
              <div>
                <div style={{ fontSize: '13px', fontWeight: 600, color: '#111' }}>Débrief Macro IA</div>
            ...
            <div style={{ fontSize: '12px', fontWeight: 600, color: '#111', marginBottom: '8px' }}>Briefing Macro — Jeudi 2 juillet 2026</div>
